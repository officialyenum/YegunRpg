...
UAnimMontage* AYegunCharacterBase::GetHitReactMontage_Implementation()
{
	return HitReactMontage;
}

void AYegunCharacterBase::Die()
{
...
void AYegunCharacterBase::MultiCastHandleDeath_Implementation()
{
